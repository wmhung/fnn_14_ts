    ...
    <MobilePanelProvider>
      <ParkDataProvider value={data}>
        ...
        <div className='relative w-full h-screen'>
          {/* Map component goes here, full screen */}
          <div id='map' className='absolute inset-0 z-0'>
            {/* Your Map component */}
          </div>

          {/* Floating Park List - Desktop */}
          <div className='absolute top-20 left-4 max-w-[23rem] max-h-[82%] p-3 hidden md:block z-10 rounded-lg shadow-xl bg-slate-50 dark:bg-slate-800'>
            <ParkLayout data={data} />
          </div>

          {/* Floating Park List - Mobile */}
